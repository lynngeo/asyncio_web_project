from modelsbak.db_op import create_pool
from modelsbak.dbstruct import User,Blog,Comment
import asyncio
from logall import *
...
async def test(loop):
    ...
    #u = User(email="test@example.com",passwd='123456',admin=0,name='mytest',image='about:blank',created_at='0419')
    #await u.save()
